...
from enfugue.diffusion.support.llm.moondream.vision_encoder import VisionEncoder
from enfugue.diffusion.support.llm.moondream.configuration_moondream import PhiConfig, MoondreamConfig
