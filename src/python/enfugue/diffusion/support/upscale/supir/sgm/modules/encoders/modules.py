...
from enfugue.diffusion.support.upscale.supir.sgm.modules.autoencoding.regularizers import DiagonalGaussianRegularizer
from enfugue.diffusion.support.upscale.supir.sgm.modules.diffusionmodules.model import Encoder
from enfugue.diffusion.support.upscale.supir.sgm.modules.diffusionmodules.openaimodel import Timestep
from enfugue.diffusion.support.upscale.supir.sgm.modules.diffusionmodules.util import extract_into_tensor, make_beta_schedule
...
class FrozenCLIPEmbedder(AbstractEmbModel):
    ...
    def __init__(
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained(version, device_map=device, cache_dir=cache_dir)
        self.transformer = CLIPTextModel.from_pretrained(version, device_map=device, cache_dir=cache_dir)
        self.device = device
        self.max_length = max_length
        if freeze:
            self.freeze()
