...
from enfugue.diffusion.train.motion.director.utils.bucketing import sensible_buckets
...
class SingleVideoDataset(DatasetProcessor, Dataset):
    def __init__(
        ...
        logger.info(f"{self.single_video_path} {self.single_video_prompt} {self.frames}")
        self.width = width
        self.height = height
