...
def inject_trainable_lora_extended(
    ...
    for _module, name, _child_module in _find_modules(
        ...
        module_name = _child_module.__class__.__name__.lower()
        if "linear" in module_name:
            ...
            if bias is not None:
                _tmp.linear.bias = bias
        elif "conv" in module_name and "3" not in module_name:
            weight = _child_module.weight
            bias = _child_module.bias
        ...
        elif "conv" in module_name and "3" in module_name:
            weight = _child_module.weight
            bias = _child_module.bias
            ...
            raise ValueError(f"Unknown child module class {module_name}")
