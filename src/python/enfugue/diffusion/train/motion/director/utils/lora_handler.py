# type: ignore
# adapted from https://github.com/ExponentialML/AnimateDiff-MotionDirector/
import os
...
from enfugue.diffusion.animate.diff.unet import UNet3DConditionModel

from enfugue.diffusion.train.motion.director.utils.convert_diffusers_to_original_ms_text_to_video import convert_unet_state_dict, convert_text_enc_state_dict_v20

from enfugue.diffusion.train.motion.director.utils.lora import (
...
from enfugue.diffusion.train.motion.director.stable_lora.lora import (
    activate_lora_train,
    add_lora_to,
    save_lora,
    load_lora,
