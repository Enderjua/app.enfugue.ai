# type: ignore
# adapted from https://github.com/Doubiiu/DynamiCrafter
"""
wild mixture of
...
from enfugue.diffusion.animate.dynamicrafter.lvdm.ema import LitEma
from enfugue.diffusion.animate.dynamicrafter.lvdm.distributions import (
    DiagonalGaussianDistribution,
)
from enfugue.diffusion.animate.dynamicrafter.lvdm.models.utils_diffusion import (
    make_beta_schedule,
    rescale_zero_terminal_snr,
)
from enfugue.diffusion.animate.dynamicrafter.lvdm.basics import disabled_train
from enfugue.diffusion.animate.dynamicrafter.lvdm.common import (
    extract_into_tensor,
    noise_like,
    exists,
    default,
...
class DDPM(pl.LightningModule):
    ...
    @torch.no_grad()
    def p_sample_loop(self, shape, temperature=1.0, return_intermediates=False):
        device = self.betas.device
        b = shape[0]
        img = noise_like(shape, device)
        intermediates = [img]
        for i in tqdm(
    ...
    def q_sample(self, x_start, t, noise=None):
        noise = default(noise, lambda: noise_like(x_start.shape, x_start.device))
        return (
    ...
    def log_images(self, batch, N=8, n_row=2, sample=True, return_keys=None, **kwargs):
        ...
        for t in range(self.num_timesteps):
            if t % self.log_every_t == 0 or t == self.num_timesteps - 1:
                ...
                noise = noise_like(x_start.shape, x_start.device)
        ...
        **kwargs,
        ...
        for i in iterator:
            ...
            if self.shorten_cond_schedule:
                ...
                cond = self.q_sample(x_start=cond, t=tc, noise=noise_like(cond.shape, cond.device))
