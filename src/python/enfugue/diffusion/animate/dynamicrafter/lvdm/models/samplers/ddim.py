...
from enfugue.diffusion.animate.dynamicrafter.lvdm.common import noise_like
from enfugue.diffusion.animate.dynamicrafter.lvdm.common import extract_into_tensor
...
class DDIMSampler(object):
    ...
    def make_schedule(
        ...
        self.register_buffer(
            ...
            to_torch(torch.sqrt(1.0 - alphas_cumprod)),
        )
        self.register_buffer(
    ...
    def ddim_sampling(
        ...
        **kwargs,
        ...
        if x_T is None:
            img = noise_like(shape, device, frame_window_size=frame_window_size, frame_window_stride=frame_window_stride)
        else:
            img = x_T
    ...
    def p_sample_ddim(
        ...
        **kwargs,
        ...
        noise = sigma_t * noise_like(x.shape, device, repeat_noise, frame_window_size=frame_window_size, frame_window_stride=frame_window_stride) * temperature
